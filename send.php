...
<?php
$config['smtp_username'] = 're1ativ3@yandex.ru';  //Смените на адрес своего почтового ящика.
$config['smtp_port'] = '465'; // Порт работы.
$config['smtp_host'] =  'ssl://smtp.yandex.ru';  //сервер для отправки почты
$config['smtp_password'] = 'AsdXoc12Wres';  //Измените пароль
$config['smtp_debug'] = true;  //Если Вы хотите видеть сообщения ошибок, укажите true вместо false
$config['smtp_charset'] = 'utf-8';	//кодировка сообщений. (windows-1251 или utf-8, итд)
$config['smtp_from'] = 'RE1ATIV3'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого"
...
if((isset($_POST['name']))&(isset($_POST['mail']))) {
	...
	echo "OK";
	$result = smtpmail($config['smtp_from'], 're1ativ3@yandex.ru', $subject, $message);
	smtpmail($config['smtp_from'], 'nikitospanfilov@gmail.com', $subject, $message);
	echo $result;
}
else {
	echo "NOT OK";
